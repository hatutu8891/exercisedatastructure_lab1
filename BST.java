...
public class BST<E extends Comparable<E>> {
	...
	// This is the support of inorder method
	public void traversalInorder(BNode<E> root, List<E> sequence) {
		if (root != null) {
			traversalInorder(root.getLeft(), sequence);
			sequence.add(root.getData());
			traversalInorder(root.getRight(), sequence);
		}
	}
	...
	// This is the support of preorder method
	public void traversalPreorder(BNode<E> root, List<E> sequence) {
		if (root != null) {
			sequence.add(root.getData());
			traversalPreorder(root.getLeft(), sequence);
			traversalPreorder(root.getRight(), sequence);
		}
	}
	...
	// This is the support of postorder method
	public void traversalPostorder(BNode<E> root, List<E> sequence) {
		if (root != null) {
			traversalPostorder(root.getLeft(), sequence);
			traversalPostorder(root.getRight(), sequence);
			sequence.add(root.getData());
		}
	}

	// This is the main method of class BST
	public static void main(String[] args) {

		// This is the test of task 1
		...
		BST<Integer> traversalTree = new BST<Integer>();
		Collection<Integer> arraylist1 = new HashSet<>();
		arraylist1.add(25);
		arraylist1.add(90);
		arraylist1.add(15);
		arraylist1.add(66);
		...
		arraylist1.add(18);
		arraylist1.add(24);
		traversalTree.add(arraylist1);
		
		//This is the testcase of inorder method
		traversalTree.inorder();
		//This is the testcase of preorder method
		traversalTree.preorder();
		//This is the testcase of postorder method
		traversalTree.postorder();
	}
}
